...
1) Время - показывает точное время

2) Погода - показывает погоду в выбранном городе (/setcity для установки города)

3) Открой сайт *название сайта* (без .com, .ru, и тд) - открывает сайт

Например: открой сайт Youtube
    
4) Запиши заметку *сама заметка* - записывает заметки

Например: запиши заметку купить таблетки

5) Открой заметки - показывает список заметок пользователя

6) Удали заметку *номер заметки*

Например: удали заметку 2 (именно цифра,а не слово)
 
7) Что такое *ваш запрос* - ищет информацию в Интернете

8) Открой проводник - открывает проводник
 
9) Выключи компьютер - выключает компьютер
      
10) Открой телеграм - открывает веб версию Telegram

11) Открой бразуер - открывает браузер по умолчанию                                                                                  
    """)
